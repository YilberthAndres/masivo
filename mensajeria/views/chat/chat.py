...
import json
from mensajeria.models import Archivos, Destinatarios, Mensajeria, Personas, Conversaciones
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            if persona:
                ...
                response_data = {"status": status.HTTP_200_OK, "data": response_data, "state": True}
                return Response(response_data)
            else:
                response_data = {"status": status.HTTP_404_NOT_FOUND, "message": "No tienes acceso.", "state": False}
                return Response(response_data)
        except Exception as e:
            response_data = {"status": status.HTTP_404_NOT_FOUND, "message": "No tienes acceso.", "state": False}
            return Response(response_data)
    ...
    def post(self, request, *args, **kwargs):
        ...
        # try:
            ...
            if(persona_model):
                ...
                response_data = {"status": status.HTTP_404_NOT_FOUND, "message": "Error destinatario no valido", "state": False}
                return Response(response_data)
        # except Exception as e:
